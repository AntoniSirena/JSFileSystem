...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = JSFileSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        return new List<ApplicationLanguage>
        {
            ...
            new ApplicationLanguage(tenantId, "es-DO", "Español Dominicano", "famfamfam-flags do"),
    ...
    public DefaultLanguagesCreator(JSFileSystemDbContext context)
    {
        _context = context;
    }
