...
using JSFileSystem.Models.TokenAuth;
...
public abstract class JSFileSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static JSFileSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(JSFileSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<JSFileSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<JSFileSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<JSFileSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<JSFileSystemDbContext, Task<T>> func)
    {
        T result;
